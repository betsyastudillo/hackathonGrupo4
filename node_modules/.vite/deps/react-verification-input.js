  ...
  "node_modules/react-verification-input/lib/index.js"(exports) {
    (() => {
      var e = { 184: (e2, n2) => {
        ...
        !function() {
          ...
          function o2() {
            for (var e3 = [], n3 = 0; n3 < arguments.length; n3++) {
              ...
              if (t3) {
                var a2 = typeof t3;
                if ("string" === a2 || "number" === a2) e3.push(t3);
                  ...
                  for (var i in t3) r2.call(t3, i) && t3[i] && e3.push(i);
                }
              }
            }
            return e3.join(" ");
        ...
        e2.exports = function(e3) {
          ...
          return n2.toString = function() {
            ...
            var c = {};
            if (r2) for (var i = 0; i < this.length; i++) {
              var l = this[i][0];
              null != l && (c[l] = true);
            }
      ...
      t.n = (e2) => {
        ...
        for (var r2 in n2) t.o(n2, r2) && !t.o(e2, r2) && Object.defineProperty(e2, r2, { enumerable: true, get: n2[r2] });
      ...
      (() => {
        ...
        function p() {
          return p = Object.assign ? Object.assign.bind() : function(e3) {
            for (var n3 = 1; n3 < arguments.length; n3++) {
              var t2 = arguments[n3];
              for (var r2 in t2) Object.prototype.hasOwnProperty.call(t2, r2) && (e3[r2] = t2[r2]);
            }
            return e3;
        ...
        function f(e3, n3) {
          ...
          var t2, r2, o3 = function(e4, n4) {
            ...
            for (r3 = 0; r3 < a4.length; r3++) t3 = a4[r3], n4.indexOf(t3) >= 0 || (o4[t3] = e4[t3]);
            return o4;
          }(e3, n3);
          if (Object.getOwnPropertySymbols) {
            var a3 = Object.getOwnPropertySymbols(e3);
            for (r2 = 0; r2 < a3.length; r2++) t2 = a3[r2], n3.indexOf(t2) >= 0 || Object.prototype.propertyIsEnumerable.call(e3, t2) && (o3[t2] = e3[t2]);
          }
          return o3;
        }
        function d(e3, n3) {
            ...
            if (null != t2) {
              ...
              try {
                if (a3 = (t2 = t2.call(e4)).next, 0 === n4) {
                  ...
                  l2 = false;
                } else for (; !(l2 = (r2 = a3.call(t2)).done) && (i2.push(r2.value), i2.length !== n4); l2 = true) ;
              } catch (e5) {
                s2 = true, o3 = e5;
              } finally {
                try {
                  if (!l2 && null != t2.return && (c2 = t2.return(), Object(c2) !== c2)) return;
                } finally {
                  if (s2) throw o3;
                }
              }
        ...
        function h(e3, n3) {
          if (e3) {
            if ("string" == typeof e3) return v(e3, n3);
        ...
        var y = (0, e2.forwardRef)(function(t2, r2) {
          ...
          return n2().createElement(n2().Fragment, null, n2().createElement("div", p({ "data-testid": "container", className: a2()("vi__container", w.container, W), onClick: function() {
            ...
            if (Array.isArray(e3)) return v(e3);
          }(N) || function(e3) {
